    ...
    <div className="container-xxl">
      <div className="row">
        <div className="col-12">
          ...
          <div className="d-flex align-items-center gap-10">
            <img src="imagens/service-04.png" alt= "services"/>
            <div>
