    ...
    <div className="row">
      ...
      <div className="col-6">
        <p className="text-end text-white mb-0">
          Contato: 
          <a ClassName="text-white" href="tel +55 (11) 91851-3204">
            +55 (11) 91851-3204
          </a> 
          </p>
      </div>
        ...
        <div className="col-5">
              <div className="input-group">
                <input
                  ...
                  aria-label="Pesquise seus produtos aqui..."
              ...
              <div className="header-upper-links d-flex align-items-center justify-content-between">
                ...
                <div>
                  <Link
                    ...
                    className="d-flex align-items-center gap-10 text-white"
                  >
                    <img src="/imagens/cart.svg" alt="cart" />
  ...
  <header className="header-bottom py-3">
        <div className="container-xxl">
          ...
          <div className="dropdown">
              ...
              aria-expanded="false">
              <img src="/imagens/menu.svg" alt=""/> <span className="me-5 d-inline-block">Categorias</span>
          </button>
